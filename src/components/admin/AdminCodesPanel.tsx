      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Panel de Códigos de Registro</h1>
        ...
        <Alert>
          <AlertDescription>
            <strong>Sistema de Control de Acceso:</strong> Las empresas necesitan un código de registro para acceder por primera vez al sistema. 
            Este código solo se puede usar una vez y puede tener fecha de expiración.
          </AlertDescription>
        </Alert>
