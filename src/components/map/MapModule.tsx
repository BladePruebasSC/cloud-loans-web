      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Clientes Cercanos</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">12</div>
            <p className="text-xs text-muted-foreground">En un radio de 5km</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Rutas programadas hoy</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">127km</div>
            <p className="text-xs text-muted-foreground">Rutas de hoy</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="h-96 bg-gray-100 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Funcionalidad de mapas en construcción. Aquí se mostrará la ubicación de todos los clientes.
              </p>
            </div>
          </div>
        </CardContent>
